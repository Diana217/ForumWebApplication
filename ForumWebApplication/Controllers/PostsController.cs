...
namespace ForumWebApplication.Controllers
{
    public class PostsController : Controller
    {
        ...
        {
            var forumContext = _context.Posts.Include(p => p.Topic);
        ...
        public async Task<IActionResult> Create([Bind("Id,TopicId,Description,Date")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TopicId,Description,Date")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ForumContext.Posts'  is null.");
            }
            var post = await _context.Posts.FindAsync(id);
            if (post != null)
            {
